...
CREATE TABLE ATTEMPT (
	...
	CONSTRAINT PK_ATTEMPT PRIMARY KEY (Cour_id, Lect_id, Quiz_id, Attempt_id),
    CONSTRAINT FK_ATTEMPT_QUIZ FOREIGN KEY (Cour_id, Lect_id, Quiz_id)
			REFERENCES QUIZ(Cour_id, Lect_id, Quiz_id)
			ON DELETE CASCADE,
	CONSTRAINT FK_ATTEMPT_STU FOREIGN KEY (Stu_id) REFERENCES STUDENT(Student_id),

    CONSTRAINT CK_ATTEMPT_ScoreRange CHECK (Score >= 0 AND Score <= 10),
...
-- 17. Bảng ATTEMPT
INSERT INTO ATTEMPT (Cour_id, Lect_id, Quiz_id, Attempt_id, Score, [Date], Start_time, Duration, Stu_id)
VALUES 
('C000000001', 'L000000001', 'Q000000001', 1, 9.50, '2024-06-10', '09:00:00', 5, 'U000000006'),
('C000000001', 'L000000001', 'Q000000001', 2, 10.00, '2024-06-10', '09:30:00', 5, 'U000000006'),
('C000000001', 'L000000002', 'Q000000002', 1, 7.00, '2024-06-11', '10:00:00', 10, 'U000000007'),
('C000000002', 'L000000001', 'Q000000001', 1, 8.25, '2024-06-12', '14:15:00', 7, 'U000000006'),
('C000000002', 'L000000002', 'Q000000002', 1, 6.75, '2024-06-13', '15:00:00', 12, 'U000000008');
GO
